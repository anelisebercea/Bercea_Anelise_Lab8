...
namespace Bercea_Anelise_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Bercea_Anelise_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Bercea_Anelise_Lab8Context context,
